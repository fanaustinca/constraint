/* The Poki submission build, generated once and written to two places:
   poki/index.html to upload, and index.html so GitHub Pages serves the very
   same bytes. Testing a different build than the one you submit is how a
...
function pokiHtml(){
  ...
  const body=src.replace(/<title>[\s\S]*?<\/title>\s*/,'')
                 ...
                 .replace(/const POKI_BUILD=false;/, "const POKI_BUILD=true;")
